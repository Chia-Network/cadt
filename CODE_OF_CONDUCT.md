...
When an incident does occur, it is important to report it promptly. To report a possible violation, email the CAD Trust Community Moderators at **contact@climateactiondata.org**. This address is monitored by more than one moderator. If your report concerns a specific moderator, you may instead contact any other moderator directly using the contacts listed in the project's `MAINTAINERS` / governance documentation, so that no report is routed through the person it names.
