 ...
 */
const TYPE_TO_TABLE = {
  methodology: 'methodology_mirror',
  program: 'program_mirror',
  project: 'project_mirror',
  validation: 'validation_mirror',
  verification: 'verification_mirror',
  issuance: 'issuance_mirror',
  unit: 'unit_mirror',
  location: 'location_mirror',
  estimation: 'estimation_mirror',
  rating: 'rating_mirror',
  'co-benefit': 'co_benefit_mirror',
  coBenefit: 'co_benefit_mirror',
  label: 'label_mirror',
  stakeholder: 'stakeholder_mirror',
  'stakeholder-projects': 'stakeholder_projects_mirror',
  stakeholderProjects: 'stakeholder_projects_mirror',
  'project-methodology': 'project_methodology_mirror',
  projectMethodology: 'project_methodology_mirror',
  'unit-label': 'unit_label_mirror',
  unitLabel: 'unit_label_mirror',
  'aef-t1-submission': 'aef_t1_submission_mirror',
  aefT1Submission: 'aef_t1_submission_mirror',
  'aef-t2-authorizations': 'aef_t2_authorizations_mirror',
  aefT2Authorizations: 'aef_t2_authorizations_mirror',
  'aef-t3-actions': 'aef_t3_actions_mirror',
  aefT3Actions: 'aef_t3_actions_mirror',
  'aef-t4-holdings': 'aef_t4_holdings_mirror',
  aefT4Holdings: 'aef_t4_holdings_mirror',
  'aef-t5-authorized-entities': 'aef_t5_authorized_entities_mirror',
  aefT5AuthorizedEntities: 'aef_t5_authorized_entities_mirror',
};
