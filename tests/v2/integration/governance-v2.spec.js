...
describe('V2 Governance Model Tests', function () {
  ...
  // createGoveranceBody and addV2ToExistingGovernanceBody model tests removed - covered by HTTP tests below
  ...
  // updateGoveranceBodyData model tests removed - covered by HTTP tests below
        ...
        await withConfigOverride(
          async () => {
            ...
            expect(response.body.message).to.include(
              'Committing this new organization list',
            );
      ...
      it('should update pickList via HTTP', async function () {
        ...
        await withConfigOverride(
          async () => {
            ...
            expect(response.status).to.equal(200);
            expect(response.body).to.have.property('success', true);
            expect(response.body.message).to.include('Committing this pick list');
      ...
      it('should update glossary via HTTP', async function () {
        ...
        await withConfigOverride(
          async () => {
            ...
            expect(response.status).to.equal(200);
            expect(response.body).to.have.property('success', true);
            expect(response.body.message).to.include('Committing glossary');
  ...
  // sync model tests removed - covered by HTTP tests below
