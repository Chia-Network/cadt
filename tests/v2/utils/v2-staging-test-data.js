...
export const generateV2AefT5AuthorizedEntitiesData = async (overrides = {}) => {
  ...
  return {
    ...
    aef_t5_authorized_entities_incorporation_country: getRandomPicklistValue('aefT5AuthorizedEntitiesIncorporationCountry') || 'United States of America',
...
export const generateV2AefT2AuthorizationsData = async (overrides = {}) => {
  ...
  return {
    ...
    aef_t2_authorizations_metric: getRandomPicklistValue('aefT2AuthorizationsMetric') || 'GHC',
    aef_t2_authorizations_gwp_value: '1.0',
    aef_t2_authorizations_applicable_non_ghg_metric: null,
    aef_t2_authorizations_sector: getRandomPicklistValue('aefT2AuthorizationsSector') || 'Energy demand',
    aef_t2_authorizations_activity_type: getRandomPicklistValue('aefT2AuthorizationsActivityType') || 'Solar',
    aef_t2_authorizations_purposes_for_authorization: getRandomPicklistValue('aefT2AuthorizationsPurposesForAuthorization') || 'NDC',
...
export const generateV2AefT3ActionsData = async (overrides = {}) => {
  ...
  return {
    ...
    aef_t3_actions_metric: getRandomPicklistValue('aefT2AuthorizationsMetric') || 'GHC',
    ...
    aef_t3_actions_mitigation_type: getRandomPicklistValue('aefT3ActionsMitigationType') || 'Emission reductions',
...
export const generateV2AefT4HoldingsData = async (overrides = {}) => {
  ...
  return {
    ...
    aef_t4_holdings_metric: getRandomPicklistValue('aefT2AuthorizationsMetric') || 'GHC',
    ...
    aef_t4_holdings_mitigation_type: getRandomPicklistValue('aefT3ActionsMitigationType') || 'Emission reductions',
