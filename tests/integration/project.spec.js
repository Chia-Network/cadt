...
describe('Project Resource Integration Tests', function () {
  ...
  describe('Original Tests', function () {
    ...
    */
      ...
      await testFixtures.checkProjectMirrorRecordDoesNotExist(
        warehouseProjectId,
      );
  ...
  describe('Testing project queries', function () {
    ...
    it('Search by search', async function () {
      const projects = await testFixtures.getProjectByQuery({
