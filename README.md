...
* **APP**: This section contains shared configuration used by both V1 and V2 APIs.
  ...
  * **TASKS**: Section for configuring sync intervals.
    * **GOVERNANCE_SYNC_TASK_INTERVAL**: Steady-state governance sync cadence after local governance data exists. Default 1800 seconds.
    * **GOVERNANCE_SYNC_BOOTSTRAP_TASK_INTERVAL**: Faster governance sync cadence used until local governance data exists. Default 300 seconds.
