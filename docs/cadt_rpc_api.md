...
- [`organizations`](#organizations)
  ...
  - [PUT Examples](#put-examples)
    - [Import a home organization](#import-a-home-organization)
  - [DELETE Examples](#delete-examples)
    - [Delete a home organization](#delete-a-home-organization)
...
- [`projects`](#projects)
  - [GET Examples](#get-examples-1)
    ...
    - [Get a single project record](#get-a-single-project-record)
    - [List projects by orguid](#list-projects-by-orguid)
    - [Search for projects](#search-for-projects)
    - [Show marketplace projects](#show-marketplace-projects)
    - [Save results to xlsx](#save-results-to-xlsx)
    - [Show requested columns](#show-requested-columns)
  - [POST Examples](#post-examples-1)
    - [Stage a new project](#stage-a-new-project)
    - [Stage from csv](#stage-from-csv)
  - [PUT Examples](#put-examples-1)
    - [Update a project](#update-a-project)
    - [Update with issuances](#update-with-issuances)
    - [Update from xlsx](#update-from-xlsx)
...
- [`units`](#units)
  - [GET Examples](#get-examples-2)
    ...
    - [Search for units](#search-for-units)
    - [Include project info](#include-project-info)
    - [List by orguid](#list-by-orguid)
    - [Save to xlsx](#save-to-xlsx)
    - [List with options](#list-with-options)
    - [Specify columns](#specify-columns)
  - [POST Examples](#post-examples-2)
    - [Create a unit](#create-a-unit)
    - [Create with issuances](#create-with-issuances)
    - [Split units](#split-units)
  - [PUT Examples](#put-examples-2)
    - [Update a unit](#update-a-unit)
    - [Update from xlsx](#update-from-xlsx)
...
- [`staging`](#staging)
  - [GET Examples](#get-examples-3)
    - [List all in staging](#list-all-in-staging)
    - [List units in staging](#list-units-in-staging)
  - [POST Examples](#post-examples-3)
    - [Commit all in staging](#commit-all-in-staging)
    - [Retry commit](#retry-commit)
  - [DELETE Examples](#delete-examples-3)
    - [Delete all in staging](#delete-all-in-staging)
    - [Delete project in staging](#delete-project-in-staging)
    - [Delete unit in staging](#delete-unit-in-staging)
...
- [`audit`](#audit)
  - [GET Examples](#get-examples-6)
    - [Show organization history](#show-organization-history)
- [`offer`](#offer)
  - [GET Examples](#get-examples-7)
    - [Generate offer file](#generate-offer-file)
    - [Get offer details](#get-offer-details)
  - [POST Examples](#post-examples-4)
    - [Upload offer file](#upload-offer-file)
...
- [`governance`](#governance)
  - [GET Examples](#get-examples-8)
    ...
    - [Get organization UIDs](#get-organization-uids)
