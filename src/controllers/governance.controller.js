...
import glossary from '../models/governance/glossary.stub.json' assert { type: 'json' };
import pickList from '../models/governance/governance.stub.json' assert { type: 'json' };
